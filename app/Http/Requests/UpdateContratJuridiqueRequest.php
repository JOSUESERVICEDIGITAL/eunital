...
class UpdateContratJuridiqueRequest extends FormRequest
{
    ...
    {
        $id = $this->route('contratJuridique')->id;

        return [
            'titre' => 'required|string|max:255',
            'reference' => "required|string|max:255|unique:contrats_juridiques,reference,$id",
