...
/* OPTION B :
   on n’empêche plus l’affichage des dropdowns.
   On les transforme en panneau flottant */
.sidebar.collapsed .submenu-wrap,
.sidebar.collapsed .nested-submenu-wrap {
    display: none !important;
}

.sidebar-floating-popup {
    position: fixed;
    width: 300px;
...
.sidebar-floating-popup .submenu-wrap,
.sidebar-floating-popup .nested-submenu-wrap {
    display: block;
    position: static;
    padding: 0;
    border: none;
...
.sidebar-floating-popup .submenu,
.sidebar-floating-popup .nested-submenu {
    padding-left: 0;
}

.sidebar-floating-popup .submenu-link,
.sidebar-floating-popup .nested-submenu-link {
    width: 100%;
}

.sidebar .menu-toggle-btn.popup-open,
.sidebar .submenu-toggle-btn.popup-open {
    background: linear-gradient(135deg, rgba(20, 184, 180, .12), rgba(17, 177, 173, .08));
    border-color: rgba(17, 177, 173, .25);
    box-shadow: var(--shadow-soft);
}
...
/* scroll propre */
.sidebar-popup-content::-webkit-scrollbar {
    width: 6px;
}

.sidebar-popup-content::-webkit-scrollbar-thumb {
    background: #cbd5e1;
    border-radius: 10px;
}
...
.topbar-popup-lg { width: 290px; }
.topbar-popup-xl { width: 370px; }
.topbar-popup-profile { width: 280px; }
...
body.dark-mode .sidebar.collapsed .submenu-wrap,
body.dark-mode .sidebar.collapsed .nested-submenu-wrap {
...
/* =========================
   STATUT SELECT
========================= */
#statutSelect.en_attente { color: #ffc107; }
