        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <h2 class="mb-1 text-white">Documents juridiques</h2>
                        <p class="mb-0 text-white-50">
                            Gestion des textes officiels, règlements, politiques, chartes, conventions et documents de conformité du hub.
                        </p>
                    </div>
                </div>
