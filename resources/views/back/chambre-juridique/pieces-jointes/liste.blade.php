        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <h2 class="mb-1 text-white">Pièces jointes juridiques</h2>
                        <p class="mb-0 text-white-50">
                            Centralisation des justificatifs, scans, annexes et preuves reliés aux contrats, engagements, dossiers et archives.
                        </p>
                    </div>
                </div>
