...
@section('title', 'Réservations annulées')
@section('page_title', 'Chambre Studio · Réservations annulées')
@section('page_subtitle', 'Liste des réservations annulées ou abandonnées.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Réservations annulées</h5>
            </div>
