...
@section('title', 'Réservations réservées')
@section('page_title', 'Chambre Studio · Réservations réservées')
@section('page_subtitle', 'Liste des réservations enregistrées en attente de confirmation.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Réservations réservées</h5>
            </div>
