...
@section('title', 'Réservations confirmées')
@section('page_title', 'Chambre Studio · Réservations confirmées')
@section('page_subtitle', 'Liste des réservations validées et confirmées pour exécution.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Réservations confirmées</h5>
            </div>
