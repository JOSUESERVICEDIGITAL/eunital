...
@section('title', 'Clients entreprises')
@section('page_title', 'Chambre Studio · Clients entreprises')
@section('page_subtitle', 'Liste des entreprises, structures et organisations clientes du studio.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Clients entreprises</h5>
            </div>
