...
@section('title', 'Captations terminées')
@section('page_title', 'Chambre Studio · Captations terminées')
@section('page_subtitle', 'Liste des captations finalisées et clôturées.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Captations terminées</h5>
            </div>
