...
@section('title', 'Captations événements')
@section('page_title', 'Chambre Studio · Captations événements')
@section('page_subtitle', 'Liste des captations d’événements, conférences, concerts et prestations diverses.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Captations événements</h5>
            </div>
