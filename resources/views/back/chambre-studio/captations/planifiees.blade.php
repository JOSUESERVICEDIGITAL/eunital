...
@section('title', 'Captations planifiées')
@section('page_title', 'Chambre Studio · Captations planifiées')
@section('page_subtitle', 'Liste des captations programmées et en attente de démarrage.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Captations planifiées</h5>
            </div>
