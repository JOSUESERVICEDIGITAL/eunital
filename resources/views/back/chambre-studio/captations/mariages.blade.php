...
@section('title', 'Captations mariages')
@section('page_title', 'Chambre Studio · Captations mariages')
@section('page_subtitle', 'Liste des captations dédiées aux mariages et cérémonies nuptiales.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            <div>
                ...
                <h5 class="mb-0">Captations mariages</h5>
            </div>
