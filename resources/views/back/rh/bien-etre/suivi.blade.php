...
@section('title', 'Suivi du dossier bien-être')
@section('page_title', 'Suivi du dossier bien-être')
@section('page_subtitle', 'Chronologie du dossier, des évolutions de statut et du suivi humain RH.')
            ...
            <div class="content-card">
                ...
                @empty
                    <div class="empty-state">
                        ...
                        <h5 class="mt-3">Aucun suivi disponible</h5>
                        <p class="text-muted">La chronologie du dossier apparaîtra ici.</p>
                    </div>
                @endforelse
            </div>
        </div>
