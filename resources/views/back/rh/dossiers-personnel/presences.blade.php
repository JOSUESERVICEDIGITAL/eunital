...
@section('page_title', 'Présences du personnel')
@section('page_subtitle', 'Historique détaillé des présences, absences, retards et pointages du collaborateur.')
            ...
            <div class="content-card">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Présences liées au dossier RH.</p>
                    </div>
                        ...
                        <tbody>
                            @forelse($presences as $presence)
                                <tr>
                                    ...
                                    <td><span class="badge rounded-pill text-bg-light border">{{ ucfirst($presence->statut) }}</span></td>
                                    <td class="text-end">
                                        <a href="{{ route('rh.presences.show', $presence) }}" class="btn btn-sm btn-light rounded-pill px-3">Voir</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <div class="empty-state">
                                            ...
                                            <h5 class="mt-3">Aucune présence</h5>
                                            <p class="text-muted">Aucune présence n’est encore enregistrée pour ce collaborateur.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
