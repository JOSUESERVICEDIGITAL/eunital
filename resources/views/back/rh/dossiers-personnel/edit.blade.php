...
@section('title', 'Modifier le dossier du personnel')
@section('page_title', 'Modifier le dossier du personnel')
@section('page_subtitle', 'Met à jour les informations administratives, salariales et professionnelles du collaborateur.')
        ...
        <div class="col-12">
            <div class="content-card">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
                    <div>
                        <h4 class="fw-bold mb-1">Modification du dossier RH</h4>
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ route('rh.dossiers-personnel.show', $dossier) }}" class="btn btn-outline-primary rounded-pill px-4">
                            <i class="fa-solid fa-eye me-2"></i>Voir la fiche
                        </a>
                ...
                <form method="POST" action="{{ route('rh.dossiers-personnel.update', $dossier) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="matricule" class="form-control custom-input @error('matricule') is-invalid @enderror"
                                   value="{{ old('matricule', $dossier->matricule) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="numero_cnss" class="form-control custom-input @error('numero_cnss') is-invalid @enderror"
                                   value="{{ old('numero_cnss', $dossier->numero_cnss) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="numero_piece_identite" class="form-control custom-input @error('numero_piece_identite') is-invalid @enderror"
                                   value="{{ old('numero_piece_identite', $dossier->numero_piece_identite) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="statut_professionnel" class="form-select custom-input @error('statut_professionnel') is-invalid @enderror">
                                @foreach($statutsProfessionnels as $key => $label)
                                    <option value="{{ $key }}" @selected(old('statut_professionnel', $dossier->statut_professionnel) == $key)>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="date_embauche" class="form-control custom-input @error('date_embauche') is-invalid @enderror"
                                   value="{{ old('date_embauche', optional($dossier->date_embauche)->format('Y-m-d')) }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="salaire_base"
                                   ...
                                   value="{{ old('salaire_base', $dossier->salaire_base) }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="notes" rows="5" class="form-control rounded-4 @error('notes') is-invalid @enderror">{{ old('notes', $dossier->notes) }}</textarea>
                        ...
                        <div class="col-12">
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a href="{{ route('rh.dossiers-personnel.show', $dossier) }}" class="btn btn-light rounded-pill px-4">
                                    Annuler
                                </a>
                            </div>
                        </div>
