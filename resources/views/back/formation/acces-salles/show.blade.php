        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="mt-4">
                        @php
                            // Utiliser la route GET publique
                            $qrData = route('public.access-salle.verifier', [
                                'code' => $accesSalle->code_acces,
                                'cour' => $accesSalle->cour_id,
                            ]);
                        @endphp
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl class="row">
                        ...
                        <dt class="col-sm-4">Salle liée</dt>
                        <dd class="col-sm-8">
                            @if ($accesSalle->salle)
                                <a href="{{ route('back.formation.salles.show', $accesSalle->salle) }}"
                                    class="text-primary">
                                    {{ $accesSalle->salle->titre }}
                                </a>
                            @else
                                <span class="text-muted">Aucune salle liée</span>
                            @endif
                        </dd>

                        <dt class="col-sm-4"></dt>Généré le</dt>
                        <dd class="col-sm-8">{{ \Carbon\Carbon::parse($accesSalle->generated_at)->format('d/m/Y H:i:s') }}
                        </dd>
                        ...
                        <dd class="col-sm-8">
                            @if ($accesSalle->expires_at)
                                ...
                                @if ($accesSalle->expires_at > now())
                                    <span class="badge badge-success ml-2">Encore
                                        {{ \Carbon\Carbon::parse($accesSalle->expires_at)->diffForHumans() }}</span>
                                @else
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body p-0">
                    @php
                        $utilisateurs = $accesSalle->utilisateurs_actifs ?? [];
                    @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($connexionTime)
                                                        ...
                                                        <br>
                                                        <small class="text-muted">depuis
                                                            {{ \Carbon\Carbon::parse($connexionTime)->diffForHumans() }}</small>
                                                    @else
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-danger"
                                                        onclick="deconnecterUtilisateur({{ $accesSalle->id }}, {{ $userId }})">
