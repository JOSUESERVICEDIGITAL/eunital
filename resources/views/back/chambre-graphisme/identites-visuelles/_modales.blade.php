<div class="modal fade" id="modalActionsIdentite{{ $identite->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-0">
                <div>
                    <h5 class="modal-title fw-bold mb-1">
                        Centre de traitement branding · {{ $identite->nom }}
                    </h5>
                    <p class="text-muted mb-0 small">
                        Actions rapides sur l’identité visuelle et son workflow.
                    </p>
                </div>
                    ...
                    <div class="col-md-12 col-xl-4">
                        <div class="content-card h-100">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <form method="POST"
                                      action="{{ route('back.chambre-graphisme.identites.delete', $identite) }}"
                                      onsubmit="return confirm('Supprimer cette identité visuelle ?')">
                                    @csrf
                                    @method('DELETE')
