...
@section('title', 'Identités visuelles en validation')
@section('page_title', 'Chambre Graphisme · Validations')
@section('page_subtitle', 'Liste des identités visuelles soumises à validation avant clôture.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h5 class="mb-0">Identités en validation</h5>
            </div>
