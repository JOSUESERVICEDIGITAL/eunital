<div class="modal fade" id="modalActionsVisuel{{ $visuel->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-0">
                <div>
                    <h5 class="modal-title fw-bold mb-1">
                        Centre publication sociale · {{ $visuel->titre }}
                    </h5>
                    <p class="text-muted mb-0 small">
                        Actions rapides sur la planification et la publication du visuel.
                    </p>
                </div>
                    ...
                    <div class="col-md-12 col-xl-4">
                        <div class="content-card h-100">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <form method="POST"
                                      action="{{ route('back.chambre-graphisme.social.delete', $visuel) }}"
                                      onsubmit="return confirm('Supprimer ce visuel réseau social ?')">
                                    @csrf
                                    @method('DELETE')
