...
@section('title', 'Supports livrés')
@section('page_title', 'Chambre Graphisme · Supports livrés')
@section('page_subtitle', 'Liste des affiches et flyers finalisés et remis.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h5 class="mb-0">Supports livrés</h5>
            </div>
