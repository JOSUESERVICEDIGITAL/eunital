...
@section('page_title', 'Chambre Graphisme · Demandes terminées')
@section('page_subtitle', 'Liste des demandes clients clôturées après traitement ou livraison.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h5 class="mb-0">Demandes terminées</h5>
            </div>
