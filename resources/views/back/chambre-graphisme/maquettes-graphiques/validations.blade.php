...
@section('title', 'Maquettes en validation')
@section('page_title', 'Chambre Graphisme · Maquettes en validation')
@section('page_subtitle', 'Liste des maquettes graphiques soumises à validation avant remise finale.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h5 class="mb-0">Maquettes en validation</h5>
            </div>
