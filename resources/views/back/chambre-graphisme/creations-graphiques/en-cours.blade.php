...
@section('title', 'Créations en cours')
@section('page_title', 'Chambre Graphisme · En cours')
@section('page_subtitle', 'Liste des créations graphiques actuellement en production.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h5 class="mb-0">Créations en cours</h5>
            </div>
