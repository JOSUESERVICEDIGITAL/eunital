...
@section('title', 'Créations brouillons')
@section('page_title', 'Chambre Graphisme · Brouillons')
@section('page_subtitle', 'Liste des créations graphiques en brouillon ou en préparation.')
    ...
    <div class="content-card mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <h5 class="mb-0">Créations en brouillon</h5>
            </div>
