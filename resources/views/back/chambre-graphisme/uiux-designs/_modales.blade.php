<div class="modal fade" id="modalActionsUiux{{ $design->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header border-0">
                <div>
                    <h5 class="modal-title fw-bold mb-1">
                        Centre design UI/UX · {{ $design->titre }}
                    </h5>
                    <p class="text-muted mb-0 small">
                        Actions rapides sur le design d’interface et son avancement.
                    </p>
                </div>
                    ...
                    <div class="col-md-12 col-xl-4">
                        <div class="content-card h-100">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <form method="POST"
                                      action="{{ route('back.chambre-graphisme.uiux.delete', $design) }}"
                                      onsubmit="return confirm('Supprimer ce design UI/UX ?')">
                                    @csrf
                                    @method('DELETE')
