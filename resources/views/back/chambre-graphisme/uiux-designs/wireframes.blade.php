...
@section('page_title', 'Chambre Graphisme · Wireframes')
@section('page_subtitle', 'Liste des structures initiales d’interfaces et parcours utilisateurs.')
